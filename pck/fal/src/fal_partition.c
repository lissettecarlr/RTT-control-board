...
void fal_show_part_table(void)
{
    ...
    LOG_D("==================== FAL partition table ====================");
    LOG_D("| %-*.*s | %-*.*s |   offset   |    length  |", part_name_max, FAL_DEV_NAME_MAX, item1, flash_dev_name_max,
    ...
    for (i = 0; i < partition_table_len; i++)
    {
        ...
        LOG_D("| %-*.*s | %-*.*s | 0x%08lx | 0x%08x |", part_name_max, FAL_DEV_NAME_MAX, part->name, flash_dev_name_max,
